    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.TimeField(auto_now_add=datetime.datetime(2020, 4, 9, 21, 23, 23, 841611), verbose_name='创建时间')),
                ('update_time', models.TimeField(auto_now=datetime.datetime(2020, 4, 9, 21, 23, 23, 841611), verbose_name='更新时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.GoodsChannelGroup', verbose_name='频道组名')),
            ],
            options={
                'verbose_name': '商品频道',
