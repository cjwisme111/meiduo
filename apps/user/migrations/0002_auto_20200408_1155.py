    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.TimeField(auto_now_add=datetime.datetime(2020, 4, 8, 11, 55, 21, 847898), verbose_name='创建时间')),
                ('update_time', models.TimeField(auto_now=datetime.datetime(2020, 4, 8, 11, 55, 21, 847898), verbose_name='更新时间')),
